...
(function(e){
    e.fn.tweet=function(t){
        ...
        function f(e){
            var t=arguments.length>1?arguments[1]:new Date;var n=parseInt((t.getTime()-e)/1e3,10);
            var r="";
            if(n<1){
                r="just now"
            }
        ...
        function c(){
            var e=n.modpath,t=n.fetch===null?n.count:n.fetch;
            if(n.list){
                ...
                var r=n.query||"from:"+n.username.join(" OR from:");
                return{url:"/1.1/search/tweets.json",parameters:{q:encodeURIComponent(r),count:t,include_entities:1}}}
        }
        function h(e,t){
            if(t){
        ...
        function p(t){
            ...
            r.tweet_id=t.id_str;r.twitter_base="http://"+n.twitter_url+"/";
            ...
            r.join=n.join_text?i(' <span class="tweet_join">{join_text}</span> ',r):" ";r.avatar=r.avatar_size?i('<a class="tweet_avatar" href="{user_url}"><img src="{avatar_url}" height="{avatar_size}" width="{avatar_size}" alt="{screen_name}\'s avatar" title="{screen_name}\'s avatar" border="0"/></a>',r):"";
            r.time=i('<span class="tweet_time"><a href="{tweet_url}" title="view tweet on twitter" target="_blank">{tweet_relative_time}</a></span>',r);
        ...
        e.fn.extend({
            linkUser:s(/(^|[\W])@(\w+)/gi,
            '$1<span class="at">@</span><a href="http://'+n.twitter_url+'/$2" target="_blank">$2</a>'),
            linkHash:s(/(?:^| )[\#]+([\w\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u00ff\u0600-\u06ff]+)/gi,
            ' <a href="http://'+n.twitter_search_url+"/search?q=%23$1&src=typd"+(n.username&&n.username.length==1&&!n.list?"&from="+n.username.join("%2BOR%2B"):"")+'" class="tweet_hashtag" target="_blank">#$1</a>'),
                ...
                e.ajax({
                    ...
                    success:function(t){
                        ...
                        if(n.intro_text)
                            s.before(o);
                        s.empty();
                        var f=e.map(a.statuses||a,p);
                        f=e.grep(f,n.filter).sort(n.comparator).slice(0,n.count);
                        s.append(e.map(f,function(e){
                        ...
                        if(n.outro_text)
                            s.after(u);
                        e(r).trigger("loaded").trigger(f.length===0?"empty":"full");
